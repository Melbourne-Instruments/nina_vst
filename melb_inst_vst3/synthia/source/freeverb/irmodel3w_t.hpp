...
class _FV3_(irmodel3wm) :
    public _FV3_(irmodel3m) {
  public:
    _FV3_(irmodel3wm)
    ();
  ...
  private:
    _FV3_(irmodel3wm)
    (const _FV3_(irmodel3wm) & x);
    _FV3_(irmodel3wm) &operator=(const _FV3_(irmodel3wm) & x);
};

class _FV3_(irmodel3w) :
    public _FV3_(irmodel3) {
  public:
    _FV3_(irmodel3w)
    ();
    ...
    virtual void mute();
    virtual void setFragmentSize(long size, long factor);
    virtual void setInitialDelay(long numsamples) noexcept(false);
