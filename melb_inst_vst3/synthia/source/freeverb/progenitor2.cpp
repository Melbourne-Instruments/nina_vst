...
// Fs = 34.125 kHz
const long FV3_(progenitor2)::iAllpassLCo[] = {
    617,
    535,
    434,
    347,
...
const long FV3_(progenitor2)::iAllpassRCo[] = {
    603,
    547,
    416,
    364,
...
const long FV3_(progenitor2)::iAllpassCLCo[] = {
    430,
    341,
    264,
    174,
};
const long FV3_(progenitor2)::iAllpassCRCo[] = {
    447,
    324,
    247,
    191,
};
const long FV3_(progenitor2)::idxOutCo2[] = {
    110,
    790,
    2,
    189,
...
FV3_(progenitor2)::FV3_(progenitor2)() noexcept(false) {
    setidiffusion1(0.78);
    setodiffusion1(0.78);
...
void FV3_(progenitor2)::processreplace(fv3_float_t *inputL, fv3_float_t *inputR, fv3_float_t *outputL, fv3_float_t *outputR, long numsamples) noexcept(false) {
    switch (reverbType) {
    ...
    while (count-- > 0) {
        ...
        Dout = delayL_23._get_z(iOutC[8]) * 0.469 + (delayL_31._get_z(iOutC[7]) - delayR_49._get_z(iOutC[9]) + delayL_31._get_z(iOutC[0]) - delayR_40._get_z(iOutC2[0]) - delayR_49._get_z(iOutC[1])) * 0.219 + (delayL_37._get_z(iOutC[10]) + allpass2L_25_27._get_z1(iOutC2[4]) + allpass2L_25_27._get_z2(iOutC2[6]) - allpass2R_43_45._get_z2(iOutC2[8]) + allpass3L_34_37._get_z1(iOutC2[10]) + allpass3L_34_37._get_z2(iOutC2[12]) + allpass3L_34_37._get_z3(iOutC2[14]) - allpass3R_52_55._get_z2(iOutC2[18])) * 0.064 + delayL_37._get_z(iOutC2[16]) * 0.045;
        ...
        Bout = delayR_40._get_z(iOutC[2]) * 0.469 + (delayR_49._get_z(iOutC[1]) - delayL_31._get_z(iOutC[3]) + delayR_49._get_z(iOutC[5]) - delayL_37._get_z(iOutC[6]) - delayL_23._get_z(iOutC2[1]) - delayL_31._get_z(iOutC2[3])) * 0.219 + (delayR_58._get_z(iOutC[4]) + allpass2R_43_45._get_z1(iOutC2[5]) + allpass2R_43_45._get_z2(iOutC2[7]) - allpass2L_25_27._get_z2(iOutC2[9]) + allpass3R_52_55._get_z1(iOutC2[11]) + allpass3R_52_55._get_z2(iOutC2[13]) + allpass3R_52_55._get_z3(iOutC2[15]) - allpass3L_34_37._get_z2(iOutC2[19])) * 0.064 + delayR_58._get_z(iOutC2[17]) * 0.045;
