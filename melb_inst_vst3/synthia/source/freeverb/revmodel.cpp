...
const long FV3_(revmodel)::combCo[] = {
    1116,
    1188,
    1277,
    1356,
...
const long FV3_(revmodel)::allpCo[] = {
    556,
    441,
    341,
    225,
...
FV3_(revmodel)::FV3_(revmodel)() noexcept(false) {
    setroomsize(0.1);
    setdamp(0.1);
}
...
void FV3_(revmodel)::processreplace(fv3_float_t *inputL, fv3_float_t *inputR, fv3_float_t *outputL, fv3_float_t *outputR, long numsamples) noexcept(false) {
    if (numsamples <= 0)
        return;
