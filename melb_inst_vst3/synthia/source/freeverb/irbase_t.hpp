...
class _FV3_(irbasem) {
  public:
    ...
    virtual void loadImpulse(const _fv3_float_t *inputL, long size) noexcept(false) = 0;
...
class _FV3_(irbase) {
  public:
    ...
    virtual void loadImpulse(const _fv3_float_t *inputL, const _fv3_float_t *inputR, long size) noexcept(false) = 0;
    virtual void unloadImpulse();
  ...
  protected:
    ...
    _FV3_(delay)
    delayDL, delayDR, delayWL, delayWR;
    _FV3_(efilter)
    filter;
