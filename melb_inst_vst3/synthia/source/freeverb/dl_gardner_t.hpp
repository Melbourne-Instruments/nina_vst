 ...
 */
class _FV3_(dl_gd_largeroom) :
    public _FV3_(delayline) {
  public:
    _FV3_(dl_gd_largeroom)
    () noexcept(false);
    virtual void setSampleRate(_fv3_float_t fs) noexcept(false);
    virtual void mute();
...
class _FV3_(gd_largeroom) :
  ...
  public:
    ...
    void setroomsize(_fv3_float_t value) {
        DL_Left.setDecay(value);
        DL_Right.setDecay(value);
    }

    void setdccutfreq(_fv3_float_t value) {
        DL_Left.setDCC(value);
        DL_Right.setDCC(value);
    }

    void setdamp(_fv3_float_t value) {
        DL_Left.setLPF(value);
        DL_Right.setLPF(value);
    }
