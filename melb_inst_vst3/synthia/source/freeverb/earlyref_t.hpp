...
class _FV3_(earlyref) :
    public _FV3_(revbase) {
  public:
    _FV3_(earlyref)
    () noexcept(false);
    ...
    virtual void mute();
    virtual void processreplace(_fv3_float_t *inputL, _fv3_float_t *inputR, _fv3_float_t *outputL, _fv3_float_t *outputR, long numsamples) noexcept(false);

    void loadPresetReflection(long program);
    long getCurrentPreset();
    void loadUserReflection(const _fv3_float_t *delayL, const _fv3_float_t *gainL, const _fv3_float_t *delayR, const _fv3_float_t *gainR, long sizeL, long sizeR) noexcept(false);
  ...
  protected:
    _FV3_(earlyref)
    (const _FV3_(earlyref) & x);
    _FV3_(earlyref) &operator=(const _FV3_(earlyref) & x);
    void loadReflection(const _fv3_float_t *delayL, const _fv3_float_t *gainL, const _fv3_float_t *delayR, const _fv3_float_t *gainR, long sizeL, long sizeR) noexcept(false);
    ...
    delayLtoR, delayRtoL;
    _FV3_(biquad)
    allpassXL, allpassL2, allpassXR, allpassR2;
    _FV3_(iir_1st)
    out1_lpf, out2_lpf, out1_hpf, out2_hpf;
