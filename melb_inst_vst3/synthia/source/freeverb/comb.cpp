...
void FV3_(comb)::setsize(long size) noexcept(false) {
#ifdef DEBUG
...
void FV3_(combm)::setsize(long size) noexcept(false) {
    setsize(size, 0);
}

void FV3_(combm)::setsize(long size, long modsize) noexcept(false) {
#ifdef DEBUG
