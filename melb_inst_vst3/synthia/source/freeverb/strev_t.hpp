...
class _FV3_(strev) :
  ...
  protected:
    ...
    bool autoDiff = true;
    _FV3_(allpass)
    allpassC[FV3_STREV_NUM_ALLPASS_4], allpassC_31_33, allpassC_55_59;
    _FV3_(allpassm)
    allpassM_23_24, allpassM_46_48;
    _FV3_(delay)
    delayC_30, delayC_39, delayC_54, delayC_63;
    _FV3_(dccut)
    dccut1;
    _FV3_(iir_1st)
    lpf_in, lpfC_30, lpfC_54, lfo1_lpf, lfo2_lpf, out1_lpf, out2_lpf;
    _FV3_(lfo)
    lfo1, lfo2;
