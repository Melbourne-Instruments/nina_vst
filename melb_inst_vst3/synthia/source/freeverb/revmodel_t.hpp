...
class _FV3_(revmodel) :
  ...
  public:
    ...
    () noexcept(false);
    virtual void mute();
    void processreplace(_fv3_float_t *inputL, _fv3_float_t *inputR, _fv3_float_t *outputL, _fv3_float_t *outputR, long numsamples) noexcept(false);
  ...
  private:
    ...
    _FV3_(allpass)
    allpassL[FV3_FREV_NUM_ALLPASS], allpassR[FV3_FREV_NUM_ALLPASS];
    _FV3_(comb)
    combL[FV3_FREV_NUM_COMB], combR[FV3_FREV_NUM_COMB];
