...
class _FV3_(irmodel2zlm) :
    public _FV3_(irmodel2m) {
  public:
    _FV3_(irmodel2zlm)
    ();
  ...
  protected:
    ...
    long ZLstart;
    _FV3_(slot)
    zlFrameSlot, zlOnlySlot;

  private:
    _FV3_(irmodel2zlm)
    (const _FV3_(irmodel2zlm) & x);
    _FV3_(irmodel2zlm) &operator=(const _FV3_(irmodel2zlm) & x);
};

class _FV3_(irmodel2zl) :
    public _FV3_(irmodel2) {
  public:
    _FV3_(irmodel2zl)
    ();
