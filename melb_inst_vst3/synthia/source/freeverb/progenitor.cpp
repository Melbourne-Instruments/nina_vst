...
// Fs = 34.125 kHz
const long FV3_(progenitor)::allpassLCo[] = {
    239,
    392,
    1944,
    612,
...
const long FV3_(progenitor)::allpassRCo[] = {
    205,
    329,
    2032,
    368,
...
const long FV3_(progenitor)::delayLCo[] = {
    1,
    2,
    1055,
    344,
...
//                                        61 16    23   31    37
const long FV3_(progenitor)::delayRCo[] = {
    1,
    625,
    835,
    500,
...
const long FV3_(progenitor)::idxOutCo[] = {
    276,
    468,
    625,
    312,
...
FV3_(progenitor)::FV3_(progenitor)() noexcept(false) {
    setrt60(2.);
    setdccutfreq(5);
    setdiffusion1(0.375);
    setdiffusion2(0.312);
...
void FV3_(progenitor)::processreplace(fv3_float_t *inputL, fv3_float_t *inputR, fv3_float_t *outputL, fv3_float_t *outputR, long numsamples) noexcept(false) {
    if (numsamples <= 0)
        return;
...
void FV3_(progenitor)::setFsFactors() {
    ...
    for (long i = 0; i < FV3_PROGENITOR_OUT_INDEX; i++)
        iOutC[i] = f_(idxOutCo[i], totalFactor);
