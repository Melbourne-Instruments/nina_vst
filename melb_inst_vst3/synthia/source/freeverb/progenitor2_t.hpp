...
class _FV3_(progenitor2) :
    public _FV3_(progenitor) {
  public:
    _FV3_(progenitor2)
    () noexcept(false);
    virtual void mute();
  ...
  protected:
    ...
    noise1;
    _FV3_(allpassm)
    iAllpassL[FV3_PROGENITOR2_NUM_IALLPASS], iAllpassR[FV3_PROGENITOR2_NUM_IALLPASS];
    _FV3_(allpass)
    iAllpassCL[FV3_PROGENITOR2_NUM_CALLPASS], iAllpassCR[FV3_PROGENITOR2_NUM_CALLPASS];
